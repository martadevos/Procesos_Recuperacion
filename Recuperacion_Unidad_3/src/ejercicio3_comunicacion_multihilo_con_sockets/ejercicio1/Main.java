 ...
 *
 * El cliente le solicita al usuario un número por teclado y lo envía al servidor. Debe
 * seguir preguntando números al cliente hasta que adivine el número secreto. Para ello,
 * el servidor para cada número que le envía el cliente le indicará si es menor, mayor o
 * es el número secreto del servidor.
 *
